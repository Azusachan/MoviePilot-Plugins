    ...
    def _items(cls, key: str, owner: Any) -> List[dict]:
        ...
        if key == "search_source_order":
            return [{"title": title, "value": value} for title, value in (
                ...
                ("聚影", "juying"), ("SeedHub", "seedhub"), ("蜜柑", "mikan"),
            ...
            {"component": "VCard", "content": [{"component": "VCardTitle", "text": "常用操作"},
                                               {"component": "VCardText", "content": [
                                                   {"component": "div", "props": {"class": "d-flex"}, "content": [
                                                       cls._button("立即搜索", "plugin/CloudSubscribeFork/sync/start"),
                                                       cls._button("停止任务", "plugin/CloudSubscribeFork/sync/stop",
                                                                   color="error"),
                                                       cls._button("刷新快照", "plugin/CloudSubscribeFork/runtime",
                                                                   method="get"),
                                                   ]}]}]},
            task_content,
            history_content,
