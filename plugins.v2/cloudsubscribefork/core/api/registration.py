...
from ..agent import (
    ...
    CloudSubscribeForkCheckinTool,
    CloudSubscribeForkCheckinHistoryTool,
    CloudSubscribeForkConfigUpdateTool,
    CloudSubscribeForkLinksTool,
    CloudSubscribeForkPerformanceTool,
    CloudSubscribeForkResourceSearchTool,
    CloudSubscribeForkResourceSelectTool,
    CloudSubscribeForkStatusTool,
    CloudSubscribeForkSyncTool,
)
...
class MoviePilotRegistration(OwnerDelegator):
    ...
    def get_actions(self) -> List[Dict[str, Any]]:
        return [
            {
                "id": "cloudsubscribefork_start_sync",
                "action_id": "cloudsubscribefork_start_sync",
                "name": "执行网盘订阅搜索",
                "func": _WorkflowActionHandler(self.workflow_start_sync),
                "kwargs": {},
            },
            {
                "id": "cloudsubscribefork_process_links",
                "action_id": "cloudsubscribefork_process_links",
                "name": "处理网盘资源链接",
        ...
        return [
            {
                ...
                "desc": "执行网盘订阅搜索",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_sync"},
            },
            {
                ...
                "desc": "立即执行榜单自动订阅",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_auto_subscribe"},
            },
            {
                "cmd": "/cloud_status",
                "event": EventType.PluginAction,
                "desc": "查看网盘订阅状态",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_status"},
            },
            {
                "cmd": "/cloud_link",
                "event": EventType.PluginAction,
                ...
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_links"},
            },
            {
                "cmd": "/cloud_checkin",
                "event": EventType.PluginAction,
                "desc": "立即执行搜索渠道签到",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_checkin"},
            },
            {
                ...
                "desc": "列举签到详情：渠道 数量",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_checkin_history"},
            },
            {
                ...
                "desc": "清理网盘订阅缓存",
                "category": "网盘订阅",
                "data": {"action": "cloudsubscribefork_cache_clear"},
            },
        ]
    ...
    def get_service(self) -> List[Dict[str, Any]]:
        ...
        if (
            ...
            services.append({
                "id": "CloudSubscribeFork_AutoSubscribe",
                "name": "榜单自动订阅服务",
        ...
        services.append({
            "id": "CloudSubscribeFork_TakeoverInstall",
            "name": "网盘订阅接管初始化",
            "trigger": DateTrigger(
                run_date=(
