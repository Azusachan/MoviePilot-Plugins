...
class SubscriptionSearchHook(OwnerDelegator):
        ...
        try:
            ...
            for method_name, method_type in self._PLATFORM_SEARCH_METHODS.items():
                ...
                if not callable(current):
                    ...
                    continue
                if getattr(current, "__cloudsubscribefork_owner__", None) is self:
                    continue

                original = getattr(
                    current, "__cloudsubscribefork_original__", current
                )
    ...
    def _create_platform_search_wrapper(
        ...
        wrapper.__cloudsubscribefork_owner__ = self
        wrapper.__cloudsubscribefork_original__ = original
        return wrapper
    ...
    def _create_subscribe_chain_wrapper(
        ...
        process_search_subscription_wrapper.__cloudsubscribefork_owner__ = self
        process_search_subscription_wrapper.__cloudsubscribefork_original__ = original
