"""CloudSubscribeFork 独立 SQLite ORM 模型。"""
...
class CloudSubscribeForkBase(DeclarativeBase):
...
class HistoryRecord(CloudSubscribeForkBase):
...
class OfflinePendingTask(CloudSubscribeForkBase):
...
class CheckinHistoryRecord(CloudSubscribeForkBase):
...
class CheckinScheduleState(CloudSubscribeForkBase):
...
class PointBudgetRecord(CloudSubscribeForkBase):
...
class AccountSnapshot(CloudSubscribeForkBase):
...
class AuthSession(CloudSubscribeForkBase):
