# CloudSubscribeFork 源码目录

本目录是 `CloudSubscribeFork` 的 MoviePilot v2 后端源码及 Release 前端产物目录。面向用户的安装、配置和功能说明见
[网盘订阅助手使用说明](../../docs/cloudsubscribefork.md)。
...
前端源码位于 [`frontend/cloudsubscribefork`](../../frontend/cloudsubscribefork)。
...
```text
CloudSubscribeFork_v<version>
cloudsubscribefork_v<version>.zip
```
